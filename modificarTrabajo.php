...
<form name="alta_usuario" method="POST" action="proc_mod_t.php" class="niceform">
<fieldset>
	...
	<dl>
		...
		<dd><input type="text" name="titulo" value="<?php echo $trabajo['t_titulo']; ?>"></dd>
	</dl>
	<dl>
		<dt><label for="trabajo">Trabajo * (máximo 500 palabras): </label></dt>
		<dd><textarea name="trabajo" cols="70" rows="20"><?php echo $trabajo['t_resumen']; ?> </textarea></dd>
	</dl>
	<dl>
		<dt><label for="keywords" >Palabras clave * : </label></dt>
		<dd><input type="text" name="keywords" value="<?php echo $trabajo['t_keywords']; ?>"></dd>
	</dl>
	<dl>
		...
		<dd>
			...
			<?php
				...
				{
					if($trabajo['t_area_id'] == $fila['a_id'])
					{
						echo "<option selected value=\"" . $fila['a_id'] ."\" > " . ucfirst($fila['a_descripcion']) . "</option> \n";
					}
					else
					{
